...
public class AssignmentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addButton = (Button) findViewById(R.id.button_addAssignment);
        textInput = (EditText) findViewById(R.id.assignmentAddInfo);
        classList = (ListView) findViewById(R.id.assignmentList);
        ...
        homeButton = findViewById(R.id.assignment_home_button);
        homeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(AssignmentsActivity.this, MainActivity.class);
                startActivity(i);
            }
        });
        ...
        classList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long id) {
                final EditText input = new EditText(AssignmentsActivity.this);
                input.setInputType(InputType.TYPE_CLASS_TEXT);

                new AlertDialog.Builder(AssignmentsActivity.this).setTitle("Edit or remove " + classes.get(i) + " from the list?").setPositiveButton("Edit", new DialogInterface.OnClickListener() {
                    @Override
                        ...
                        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (edit_text.trim().equals("")) {
                                    //Toast.makeText(AssignmentsActivity.this, "Item is empty", Toast.LENGTH_SHORT).show();
                                    //dialog.dismiss();
                                }
